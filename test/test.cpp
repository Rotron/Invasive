...
void Test::testFrame()
{
    ...
    QCOMPARE(Frame::verify(QByteArray(reinterpret_cast<const char*>(packet), sizeof(packet))), true);

    Frame frame(QDateTime::currentDateTime(), QByteArray(reinterpret_cast<const char*>(packet), sizeof(packet)));
